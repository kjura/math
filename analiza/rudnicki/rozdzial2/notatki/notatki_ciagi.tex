...
\end{description}
    ...
    \end{equation*}
    %
    Z założenia wiemy, że $x_{n-1} \leq 2$ a to oznacza, że $x_{n-1}$ jest ograniczone (UWAGA BŁĄD! NIE MAKSIMUM DLA XN2!):
    %
    \begin{equation*}
...
\begin{equation*}
    x_{n} - x_{n-1} = \frac{1}{2}x_{n-1} + 1 - x_{n-1} = 1 - \frac{1}{2}x_{n-1} = \frac{1}{2}(2 - x_{n-1})
\end{equation*}
%
Pokazaliśmy powyżej, że dla dowolnego $n \in \mathbb{N}$ $x_{n} \leq 2$
